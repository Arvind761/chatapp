const socket = io(); // Works for both local & deployed
...
function generateMessage(username, message, side, status = "", messageId = "") {
  ...
  if (side === "right") container.classList.add("align-end");
  else if (side === "left") container.classList.add("align-start");
  else container.classList.add("align-center");
